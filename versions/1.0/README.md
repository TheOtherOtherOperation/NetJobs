...
## Requirements
Any machine running Python 3.3 or later.
...
If "-generaltimeout" is set, all targets specified after it will default to that timeout. As such, if "-generaltimeout" is going to be used, it should generally be set as the first line of a new test block. This value can be overwritten on a target-by-target basis by use of the "-timeout" flag.
...
This document was last updated on 07/10/15.